...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO jobs (job_title, description, location, region, job_time, experience, salary, responsibility, education_required, company_name, company_email, company_id, company_tagline, company_website, company_fb, company_tw, company_linkedin, company_image)
            VALUES ('$job_title', '$description', '$location', '$region', '$job_time', '$experience', '$salary', '$responsibility', '$education_required', '$company_name', '$company_email', '$company_id', '$company_tagline', '$company_website', '$company_fb', '$company_tw', '$company_linkedin', '$company_image')";
